...
namespace ROSControl
{
  ...
  public:
    ...
    bool readRecieved(Recieved *data);
    bool sendState(const Returns& data); 

  private:
    bool readDataFromROS(bytePtr data);
    bool sendCurrentStateOfSprinter(constBytePtr data, size_t data_size);
